package code.gdi.fachada;

import code.gdi.exceptions.*;
import code.gdi.negocio.NegociosOnibus;
import code.gdi.Main;
import code.gdi.abstracts.VEM;
import code.gdi.javafx.StageTools;
import code.gdi.negocio.NegociosPessoa;
import code.gdi.negocio.NegociosVEM;
import code.gdi.negocio.Onibus;
import code.gdi.negocio.pessoas.Estudante;
import code.gdi.negocio.pessoas.Trabalhador;
import code.gdi.negocio.vem.VEMComum;
...
public class Fachada {
    ...
    private Fachada() {
        try {
            ...
            BufferedReader in = new BufferedReader(new FileReader(Main.class.getResource("/values/config.txt").getPath()));
